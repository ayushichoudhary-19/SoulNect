...
import { IconArrowLeft, IconPlayerPlay, IconVolume } from "../components/icons/TablerIcons";
...
const MeditationStartPage = () => {
  ...
  const handleThemeSelect = (theme) => {
    navigate("/meditation/session", { state: { duration: selectedDuration, theme } })
  }
...
>
  {/* Audio Preview Button - Top Right */}
  <button
    onClick={(e) => {
      e.stopPropagation()
  ...
  <div className="aspect-w-4 aspect-h-3 w-full">
    <img
      src={theme.image || `/placeholder.svg?height=300&width=400`}
      alt={theme.name}
